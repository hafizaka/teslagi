...
<div style="margin-left:20px">
  ...
  <table border="1px" style="border-color:rgb(22, 198, 0)" width="790px">
    <tr>
      <td style="padding:10px;border-color:rgb(22, 198, 0)"><p style="font-size:35px">SELAMAT DATANG DI My LIBRARY</p></td>
    </tr>
    <tr>
      <td style="padding:30px;border-color:rgb(22, 198, 0)"><p style="line-height:30px;font-size:20px">SILAHKAN MELIHAT DAFTAR BUKU YANG TERSEDIA, <br>
        SEMOGA MY LIBRARY BERMANFAAT BAGI ANDA<br><br><br><br><br><br><br></td>
    </tr>
  </table>
</div>
</div>
