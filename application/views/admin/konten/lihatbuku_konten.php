...
<div style="margin-left:20px">
  <table border="1px" style="border-color:rgb(22, 198, 0)" width="790px">
    <tr>
      <td colspan="9" style="padding:10px 10px 0 10px"><p style="font-size:25px" align="center">LIST BUKU</p></td>
    </tr>
    ...
    <div style="font-size:50px">
        <tr style="font-size:10px">
          ...
          <td>&nbsp;<a href="<?php echo site_url('admin/editbuku/'.$book->id_buku); ?>" class="btn btn-primary btn-sm"> EDIT</a> &nbsp;
              <a href="<?php echo site_url('admin/hapusbuku/'.$book->id_buku); ?>" class="btn btn-primary btn-sm">DELETE</a></td>
        </tr>
  </div>
    <?php $nomor++; } ?>
  </table>
